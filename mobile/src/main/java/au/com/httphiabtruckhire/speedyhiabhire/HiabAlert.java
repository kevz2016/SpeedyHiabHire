...
public class HiabAlert extends Service {
    private static final String TAG = HiabAlert.class.getSimpleName();

    public static final String READ_ACTION =
            "au.com.httphiabtruckhire.speedyhiabhire.ACTION_MESSAGE_READ";
    public static final String REPLY_ACTION =
            "au.com.httphiabtruckhire.speedyhiabhire.ACTION_MESSAGE_REPLY";
