...
public class MessageReplyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (HiabComs.REPLY_ACTION.equals(intent.getAction())) {
            int conversationId = intent.getIntExtra(HiabComs.CONVERSATION_ID, -1);
    ...
    private CharSequence getMessageText(Intent intent) {
        ...
        if (remoteInput != null) {
            return remoteInput.getCharSequence(HiabComs.EXTRA_VOICE_REPLY);
        }
        return null;
    }
}
